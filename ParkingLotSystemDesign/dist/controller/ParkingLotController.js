...
const DefaultParkingStrategy_1 = __importDefault(require("../model/DefaultParkingStrategy"));
...
class ParkingLotController {
    createParkingLot(id, totalFloors, totalSlots) {
        ...
        this.parkingLot = new ParkingLot_1.default(id, new DefaultParkingStrategy_1.default);
